...
- The UpdaterFactory choice based on lists of every different kind of items is probably overkill and not really a requirement, but I just couldn't find it in me to leave an hardcoded equals just lying there (so bear with me :P)
